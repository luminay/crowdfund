...
import com.wf.crowd.entity.po.ReturnPOExample;
...
public interface ReturnPOMapper {
    ...
    void insertReturnPOBatch(@Param("returnPOList") List<ReturnPO> returnPOList, @Param("projectPOId") Integer projectPOId);
}